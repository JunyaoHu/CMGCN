...
class Tokenizer4Bert:
    ...
    # tokens
    # ['[CLS]', 'so', 'much', 'for', 'free', 'rewards', ',', 'gon', 'na', 'take', 'me', 'twice', 'as', 'long', 'now', '.', 'thanks', '<', 'user', '>', '[SEP]']
    # box_tokens
    # [['brown'], ['blue'], ['silver'], ['black'], ['blue'], [], ['white'], ['blue'], ['black'], ['white']]
    # True
...
class Dataset(Dataset):
    def __init__(self, fname, tokenizer):
        ...
        for key,value in data.items():
            ...
            # dic[id_] = {
            #     'text':text,
            #     'label':int(label),         [check]
            #     'tokens':tokens,            [check]
            #     'graph':text_graph,         [check]
            #     'box_tokens':box_token,     [check]
            #     'box_vit':box_vit,          [check]
            #     'image_graph':image_graph,  [check] 
            #     "flags":flags,
            #     "flag":flag,
            #     'word':word,
            #     "box_text":box_text
