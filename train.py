...
class Instructor:
    def __init__(self, opt):
        ...
        self.model = CMGCN.CMGCN(bert, opt).to(opt.device)
...
def main():
    ...
    parser.add_argument('--bert_dim', default=300, type=int)
    ...
    dataset_files = {
        'box_top10':
        {
            'train': 'processed_train_box_top10.data',
            'test': 'processed_test_box_top10.data',
            'val':'processed_valid_box_top10.data'
        },
    }
    input_colses = {
